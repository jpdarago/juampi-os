...
// Initialize and detect disks
void hdd_init(void);
// Read (using LBA 28) a number of bytes from a disk into a buffer
void hdd_read(uint, uint32, void*);
// Write (using LBA 28) a number of bytes from a disk into a buffer
