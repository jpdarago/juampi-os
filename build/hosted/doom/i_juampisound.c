...
// --- Music: not implemented (Init returns false -> Doom runs without music) --
...
static void I_JP_SetMusicVolume(int v)
{
    (void)v;
}
...
static void* I_JP_RegisterSong(void* d, int l)
{
    (void)d;
    (void)l;
    return NULL;
}
static void I_JP_UnRegisterSong(void* h)
{
    (void)h;
}
static void I_JP_PlaySong(void* h, boolean loop)
{
    (void)h;
    (void)loop;
}
