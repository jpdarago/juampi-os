// 8x16 monospace bitmap font for the microui renderer (src/ui.c) and the gfx
// glyph blitter. Extracted verbatim from the vendored flanterm default font
// (src/flanterm/flanterm_backends/fb.c) so on-screen UI text matches the
// console. 256 glyphs x 16 rows, one byte per row, bit 0x80 = leftmost pixel.
#ifndef __FONT8X16_H
#define __FONT8X16_H
#include <stdint.h>
