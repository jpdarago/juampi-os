...
static intptr excph_addresses[] = {
        (intptr)&_isr0,  (intptr)&_isr1,  (intptr)&_isr2,  (intptr)&_isr3,
        (intptr)&_isr4,  (intptr)&_isr5,  (intptr)&_isr6,  (intptr)&_isr7,
        (intptr)&_isr8,  (intptr)&_isr9,  (intptr)&_isr10, (intptr)&_isr11,
        (intptr)&_isr12, (intptr)&_isr13, (intptr)&_isr14, (intptr)&_isr15,
        (intptr)&_isr16, (intptr)&_isr17, (intptr)&_isr18, (intptr)&_isr19};
...
static intptr inter_handlers[] = {
        (intptr)&_irq0,  (intptr)&_irq1,  (intptr)&_irq2,  (intptr)&_irq3,
        (intptr)&_irq4,  (intptr)&_irq5,  (intptr)&_irq6,  (intptr)&_irq7,
        (intptr)&_irq8,  (intptr)&_irq9,  (intptr)&_irq10, (intptr)&_irq11,
        (intptr)&_irq12, (intptr)&_irq13, (intptr)&_irq14, (intptr)&_irq15};
