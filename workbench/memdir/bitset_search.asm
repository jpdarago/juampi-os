...
bitset_search:
	...
	mov ecx, [eax+4]
	;En esi podemos la direccion de inicio del bitset
	mov edi, [eax]
	...
	cmp ecx, 0
	;Si nos fuimos del mapa, devolvemos 0xFFFFFF
	...
	not ecx
	bsf edx,ecx
	;Conseguimos el offset de la base
	mov eax, edi
	sub eax, ebx
	;Multiplicamos por ocho porque el offset es en bytes
	shl eax, 3
	;Agregamos el offset al indice del bit
	add eax, edx
.end:
	pop ebx
	pop edi
